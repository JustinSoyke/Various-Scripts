"""
Multiprocessing Port Scanner & Banner Grab

Version 0.1
Written by Justin Soyke

Simple multiprocessing port scanner and banner grab script
Scans all 65535 Ports and checks if it's open
Retrieves the Service Banner if an Open Port is found
...
portScan:
Checks the open ports on IP Address

bannerGrab:
Retrieves the service banner
